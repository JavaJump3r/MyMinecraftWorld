...
#tellraw @a {"score":{"name":"*x","objective":"zcbm_random"}}

function #zcbm_core:worldgen


#execute if score *x zcbm_random matches 100..500 run fill ~ 2 ~ ~15 2 ~15 glass
#function zcbm_core:world/chance
#function zcbm_core:world/ex/gen
