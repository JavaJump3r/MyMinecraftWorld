scoreboard players set zcbm_mem zcbm_M3 3
...
scoreboard players operation @s zcbm_M1 = zcbm_mem zcbm_M3
function zcbm_core:mat/randomizer/get_random
scoreboard players operation @s zcbm_random *= zcbm_mem zcbm_M2
scoreboard players operation zcbm_mem zcbm_M2 /= 2 zcbm_CONST
scoreboard players operation @s zcbm_X -= zcbm_mem zcbm_M2
scoreboard players operation @s zcbm_random /= 1000 zcbm_CONST
scoreboard players operation @s zcbm_X += @s zcbm_random
scoreboard players operation @s zcbm_M1 = zcbm_mem zcbm_M3
function zcbm_core:mat/randomizer/get_random
scoreboard players operation @s zcbm_random *= zcbm_mem zcbm_M2
scoreboard players operation @s zcbm_Y -= zcbm_mem zcbm_M2
scoreboard players operation @s zcbm_random /= 500 zcbm_CONST
scoreboard players operation @s zcbm_Y += @s zcbm_random
scoreboard players operation @s zcbm_M1 = zcbm_mem zcbm_M3
function zcbm_core:mat/randomizer/get_random
scoreboard players operation @s zcbm_random *= zcbm_mem zcbm_M2
scoreboard players operation @s zcbm_Z -= zcbm_mem zcbm_M2
scoreboard players operation @s zcbm_random /= 500 zcbm_CONST
scoreboard players operation @s zcbm_Z += @s zcbm_random